...
Original file is located at
    https://colab.research.google.com/drive/1waW7vUJCRCRP5-HSYBcL-xxM_jQhMqC5
"""

!nvidia-smi

# NOTE: pip shows imcompatible errors due to preinstalled libraries but you do not need to care
!pip install -q espnet pyopenjtalk parallel_wavegan espnet_model_zoo
...
caption_model.save_weights('./checkpoints/my_checkpoint')
